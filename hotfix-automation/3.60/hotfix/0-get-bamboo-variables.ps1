...
# 	-------------------------
	...
	Write-Host 	Branch Name : $Branch_Type
	Write-Host 	CPP-Code-2015 Repository:
	Write-Host 	Branch Name : $Repository1_Name
	Write-Host 	Current Commit Revision Number : $Branch1_Revision_No
	Write-Host 	External For VS 2015 Repository:
	Write-Host 	Branch Name : $Repository2_Name
	Write-Host 	"Bamboo Plan Branch Type" : $Branch2_Name
